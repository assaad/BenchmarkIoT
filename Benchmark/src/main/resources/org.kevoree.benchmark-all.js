            ...
            (function (bench) {
                var SmartSystemModel = (function (_super) {
                    ...
                    function SmartSystemModel() {
                        _super.call(this);
                        this._metaModel = new org.kevoree.modeling.api.abs.AbstractMetaModel("SmartSystem", -1);
                    ...
                    SmartSystemModel.prototype.internal_create = function (key) {
                        return new org.kevoree.modeling.bench.SmartSystemUniverse(this, key);
                    };
                ...
                var SmartSystemUniverse = (function (_super) {
                    ...
                    function SmartSystemUniverse(p_model, key) {
                        _super.call(this, p_model, key);
                    }
                    SmartSystemUniverse.prototype.internal_create = function (timePoint) {
                        return new org.kevoree.modeling.bench.impl.SmartSystemViewImpl(timePoint, this);
                    };
                ...
                (function (impl) {
                    var DiscreteSensorImpl = (function (_super) {
                        ...
                        function DiscreteSensorImpl(p_factory, p_uuid, p_metaClass) {
                        ...
                        DiscreteSensorImpl.prototype.view = function () {
                    ...
                    var PolynomialSensorImpl = (function (_super) {
                        ...
                        function PolynomialSensorImpl(p_factory, p_uuid, p_metaClass) {
                            _super.call(this, p_factory, p_uuid, p_metaClass);
                        }
                        ...
                        PolynomialSensorImpl.prototype.view = function () {
                            return _super.prototype.view.call(this);
                        };
                    ...
                    var RoomImpl = (function (_super) {
                        ...
                        function RoomImpl(p_factory, p_uuid, p_metaClass) {
                            _super.call(this, p_factory, p_uuid, p_metaClass);
                        }
                        ...
                        RoomImpl.prototype.setSensors = function (p_obj) {
                            this.mutate(org.kevoree.modeling.api.KActionType.SET, org.kevoree.modeling.bench.meta.MetaRoom.REF_SENSORS, p_obj);
                            return this;
                        };
                        RoomImpl.prototype.getSensors = function () {
                            var task = new org.kevoree.modeling.api.abs.AbstractKDeferWrapper();
                            this.internal_ref(org.kevoree.modeling.bench.meta.MetaRoom.REF_SENSORS, function (kObjects) {
                        ...
                        RoomImpl.prototype.view = function () {
                            return _super.prototype.view.call(this);
                        };
                        return RoomImpl;
                    })(org.kevoree.modeling.api.abs.AbstractKObject);
                    ...
                    var SensorImpl = (function (_super) {
                        ...
                        function SensorImpl(p_factory, p_uuid, p_metaClass) {
                            _super.call(this, p_factory, p_uuid, p_metaClass);
                        }
                        ...
                        SensorImpl.prototype.view = function () {
                            return _super.prototype.view.call(this);
                        };
                        return SensorImpl;
                    })(org.kevoree.modeling.api.abs.AbstractKObject);
                    ...
                    var SmartSystemImpl = (function (_super) {
                        ...
                        function SmartSystemImpl(p_factory, p_uuid, p_metaClass) {
                            _super.call(this, p_factory, p_uuid, p_metaClass);
                        }
                        SmartSystemImpl.prototype.addRooms = function (p_obj) {
                            this.mutate(org.kevoree.modeling.api.KActionType.ADD, org.kevoree.modeling.bench.meta.MetaSmartSystem.REF_ROOMS, p_obj);
                            return this;
                        };
                        SmartSystemImpl.prototype.removeRooms = function (p_obj) {
                            this.mutate(org.kevoree.modeling.api.KActionType.REMOVE, org.kevoree.modeling.bench.meta.MetaSmartSystem.REF_ROOMS, p_obj);
                            return this;
                        };
                        SmartSystemImpl.prototype.getRooms = function () {
                            var task = new org.kevoree.modeling.api.abs.AbstractKDeferWrapper();
                            this.internal_ref(org.kevoree.modeling.bench.meta.MetaSmartSystem.REF_ROOMS, function (kObjects) {
                        ...
                        SmartSystemImpl.prototype.view = function () {
                            return _super.prototype.view.call(this);
                        };
                    ...
                    var SmartSystemViewImpl = (function (_super) {
                        ...
                        function SmartSystemViewImpl(p_now, p_universe) {
                            _super.call(this, p_now, p_universe);
                        }
                        SmartSystemViewImpl.prototype.internalCreate = function (p_clazz, p_key) {
                            if (p_clazz == null) {
                                return null;
                            }
                            switch (p_clazz.index()) {
                                case 1:
                                    return new org.kevoree.modeling.bench.impl.RoomImpl(this, p_key, p_clazz);
                                case 4:
                                    return new org.kevoree.modeling.bench.impl.PolynomialSensorImpl(this, p_key, p_clazz);
                                case 0:
                                    return new org.kevoree.modeling.bench.impl.SmartSystemImpl(this, p_key, p_clazz);
                                case 3:
                                    return new org.kevoree.modeling.bench.impl.DiscreteSensorImpl(this, p_key, p_clazz);
                                case 2:
                                    return new org.kevoree.modeling.bench.impl.SensorImpl(this, p_key, p_clazz);
                                default:
                        ...
                        SmartSystemViewImpl.prototype.universe = function () {
                ...
                (function (meta) {
                    var MetaDiscreteSensor = (function (_super) {
                        ...
                        MetaDiscreteSensor.ATT_NAME = new org.kevoree.modeling.api.abs.AbstractMetaAttribute("name", 4, 0, false, org.kevoree.modeling.api.meta.PrimitiveTypes.STRING, org.kevoree.modeling.api.extrapolation.DiscreteExtrapolation.instance());
                        MetaDiscreteSensor.ATT_VALUE = new org.kevoree.modeling.api.abs.AbstractMetaAttribute("value", 5, 0, false, org.kevoree.modeling.api.meta.PrimitiveTypes.DOUBLE, org.kevoree.modeling.api.extrapolation.DiscreteExtrapolation.instance());
                    ...
                    var MetaRoom = (function (_super) {
                        ...
                        MetaRoom.ATT_NAME = new org.kevoree.modeling.api.abs.AbstractMetaAttribute("name", 4, 0, false, org.kevoree.modeling.api.meta.PrimitiveTypes.STRING, org.kevoree.modeling.api.extrapolation.DiscreteExtrapolation.instance());
                        MetaRoom.REF_SENSORS = new org.kevoree.modeling.api.abs.AbstractMetaReference("sensors", 5, true, true, function () {
                    ...
                    var MetaSensor = (function (_super) {
                        ...
                        MetaSensor.ATT_NAME = new org.kevoree.modeling.api.abs.AbstractMetaAttribute("name", 4, 0, false, org.kevoree.modeling.api.meta.PrimitiveTypes.STRING, org.kevoree.modeling.api.extrapolation.DiscreteExtrapolation.instance());
                        return MetaSensor;
                    })(org.kevoree.modeling.api.abs.AbstractMetaClass);
                    ...
                    var MetaSmartSystem = (function (_super) {
                        ...
                        MetaSmartSystem.REF_ROOMS = new org.kevoree.modeling.api.abs.AbstractMetaReference("rooms", 4, false, false, function () {
                            return org.kevoree.modeling.bench.meta.MetaRoom.getInstance();
                        }, null, function () {
