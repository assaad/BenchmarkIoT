...
(function (org) {
    ...
    (function (kevoree) {
        ...
        (function (modeling) {
            var bench;
            (function (bench) {
                var SmartSystemModel = (function (_super) {
                    __extends(SmartSystemModel, _super);
                    function SmartSystemModel() {
                        _super.call(this);
                        this._metaModel = new org.kevoree.modeling.meta.impl.MetaModel("SmartSystem");
                        var tempMetaClasses = new Array();
                        tempMetaClasses[1] = org.kevoree.modeling.bench.meta.MetaRoom.getInstance();
                        tempMetaClasses[4] = org.kevoree.modeling.bench.meta.MetaPolynomialSensor.getInstance();
                        tempMetaClasses[0] = org.kevoree.modeling.bench.meta.MetaSmartSystem.getInstance();
                        tempMetaClasses[3] = org.kevoree.modeling.bench.meta.MetaDiscreteSensor.getInstance();
                        tempMetaClasses[2] = org.kevoree.modeling.bench.meta.MetaSensor.getInstance();
                        this._metaModel.init(tempMetaClasses);
                    }
                    SmartSystemModel.prototype.internalCreateUniverse = function (key) {
                        return new org.kevoree.modeling.bench.SmartSystemUniverse(key, this._manager);
                    };
                    SmartSystemModel.prototype.metaModel = function () {
                        return this._metaModel;
                    };
                    SmartSystemModel.prototype.internalCreateObject = function (universe, time, uuid, p_clazz) {
                        if (p_clazz == null) {
                            return null;
                        }
                        switch (p_clazz.index()) {
                            case 1:
                                return new org.kevoree.modeling.bench.impl.RoomImpl(universe, time, uuid, p_clazz, this._manager);
                            case 4:
                                return new org.kevoree.modeling.bench.impl.PolynomialSensorImpl(universe, time, uuid, p_clazz, this._manager);
                            case 0:
                                return new org.kevoree.modeling.bench.impl.SmartSystemImpl(universe, time, uuid, p_clazz, this._manager);
                            case 3:
                                return new org.kevoree.modeling.bench.impl.DiscreteSensorImpl(universe, time, uuid, p_clazz, this._manager);
                            case 2:
                                return new org.kevoree.modeling.bench.impl.SensorImpl(universe, time, uuid, p_clazz, this._manager);
                            default:
                                return new org.kevoree.modeling.meta.impl.GenericObject(universe, time, uuid, p_clazz, this._manager);
                        }
                    };
                    SmartSystemModel.prototype.createRoom = function (universe, time) {
                        return this.create(org.kevoree.modeling.bench.meta.MetaRoom.getInstance(), universe, time);
                    };
                    SmartSystemModel.prototype.createPolynomialSensor = function (universe, time) {
                        return this.create(org.kevoree.modeling.bench.meta.MetaPolynomialSensor.getInstance(), universe, time);
                    };
                    SmartSystemModel.prototype.createSmartSystem = function (universe, time) {
                        return this.create(org.kevoree.modeling.bench.meta.MetaSmartSystem.getInstance(), universe, time);
                    };
                    SmartSystemModel.prototype.createDiscreteSensor = function (universe, time) {
                        return this.create(org.kevoree.modeling.bench.meta.MetaDiscreteSensor.getInstance(), universe, time);
                    };
                    SmartSystemModel.prototype.createSensor = function (universe, time) {
                        return this.create(org.kevoree.modeling.bench.meta.MetaSensor.getInstance(), universe, time);
                    };
                    return SmartSystemModel;
                })(org.kevoree.modeling.abs.AbstractKModel);
                bench.SmartSystemModel = SmartSystemModel;
                var SmartSystemUniverse = (function (_super) {
                    __extends(SmartSystemUniverse, _super);
                    function SmartSystemUniverse(p_key, p_manager) {
                        _super.call(this, p_key, p_manager);
                    }
                    SmartSystemUniverse.prototype.internal_create = function (timePoint) {
                        return new org.kevoree.modeling.bench.impl.SmartSystemViewImpl(this._universe, timePoint, this._manager);
                    };
                    return SmartSystemUniverse;
                })(org.kevoree.modeling.abs.AbstractKUniverse);
                bench.SmartSystemUniverse = SmartSystemUniverse;
                var impl;
                (function (impl) {
                    var DiscreteSensorImpl = (function (_super) {
                        __extends(DiscreteSensorImpl, _super);
                        function DiscreteSensorImpl(p_universe, p_time, p_uuid, p_metaClass, p_manager) {
                            _super.call(this, p_universe, p_time, p_uuid, p_metaClass, p_manager);
                        }
                        DiscreteSensorImpl.prototype.getName = function () {
                            return this.get(org.kevoree.modeling.bench.meta.MetaDiscreteSensor.ATT_NAME);
                        };
                        DiscreteSensorImpl.prototype.setName = function (p_obj) {
                            this.set(org.kevoree.modeling.bench.meta.MetaDiscreteSensor.ATT_NAME, p_obj);
                            return this;
                        };
                        DiscreteSensorImpl.prototype.getValue = function () {
                            return this.get(org.kevoree.modeling.bench.meta.MetaDiscreteSensor.ATT_VALUE);
                        };
                        DiscreteSensorImpl.prototype.setValue = function (p_obj) {
                            this.set(org.kevoree.modeling.bench.meta.MetaDiscreteSensor.ATT_VALUE, p_obj);
                            return this;
                        };
                        return DiscreteSensorImpl;
                    })(org.kevoree.modeling.abs.AbstractKObject);
                    impl.DiscreteSensorImpl = DiscreteSensorImpl;
                    var PolynomialSensorImpl = (function (_super) {
                        __extends(PolynomialSensorImpl, _super);
                        function PolynomialSensorImpl(p_universe, p_time, p_uuid, p_metaClass, p_manager) {
                            _super.call(this, p_universe, p_time, p_uuid, p_metaClass, p_manager);
                        }
                        PolynomialSensorImpl.prototype.getName = function () {
                            return this.get(org.kevoree.modeling.bench.meta.MetaPolynomialSensor.ATT_NAME);
                        };
                        PolynomialSensorImpl.prototype.setName = function (p_obj) {
                            this.set(org.kevoree.modeling.bench.meta.MetaPolynomialSensor.ATT_NAME, p_obj);
                            return this;
                        };
                        PolynomialSensorImpl.prototype.getValue = function () {
                            return this.get(org.kevoree.modeling.bench.meta.MetaPolynomialSensor.ATT_VALUE);
                        };
                        PolynomialSensorImpl.prototype.setValue = function (p_obj) {
                            this.set(org.kevoree.modeling.bench.meta.MetaPolynomialSensor.ATT_VALUE, p_obj);
                            return this;
                        };
                        return PolynomialSensorImpl;
                    })(org.kevoree.modeling.abs.AbstractKObject);
                    impl.PolynomialSensorImpl = PolynomialSensorImpl;
                    var RoomImpl = (function (_super) {
                        __extends(RoomImpl, _super);
                        function RoomImpl(p_universe, p_time, p_uuid, p_metaClass, p_manager) {
                            _super.call(this, p_universe, p_time, p_uuid, p_metaClass, p_manager);
                        }
                        RoomImpl.prototype.getName = function () {
                            return this.get(org.kevoree.modeling.bench.meta.MetaRoom.ATT_NAME);
                        };
                        RoomImpl.prototype.setName = function (p_obj) {
                            this.set(org.kevoree.modeling.bench.meta.MetaRoom.ATT_NAME, p_obj);
                            return this;
                        };
                        RoomImpl.prototype.setSensors = function (p_obj) {
                            this.mutate(org.kevoree.modeling.KActionType.SET, org.kevoree.modeling.bench.meta.MetaRoom.REF_SENSORS, p_obj);
                            return this;
                        };
                        RoomImpl.prototype.getSensors = function (cb) {
                            if (cb == null) {
                                return;
                            }
                            this.ref(org.kevoree.modeling.bench.meta.MetaRoom.REF_SENSORS, function (kObjects) {
                    ...
                    impl.RoomImpl = RoomImpl;
                    var SensorImpl = (function (_super) {
                        __extends(SensorImpl, _super);
                        function SensorImpl(p_universe, p_time, p_uuid, p_metaClass, p_manager) {
                            _super.call(this, p_universe, p_time, p_uuid, p_metaClass, p_manager);
                        }
                        SensorImpl.prototype.getName = function () {
                            return this.get(org.kevoree.modeling.bench.meta.MetaSensor.ATT_NAME);
                        };
                        SensorImpl.prototype.setName = function (p_obj) {
                            this.set(org.kevoree.modeling.bench.meta.MetaSensor.ATT_NAME, p_obj);
                            return this;
                        };
                        return SensorImpl;
                    })(org.kevoree.modeling.abs.AbstractKObject);
                    impl.SensorImpl = SensorImpl;
                    var SmartSystemImpl = (function (_super) {
                        __extends(SmartSystemImpl, _super);
                        function SmartSystemImpl(p_universe, p_time, p_uuid, p_metaClass, p_manager) {
                            _super.call(this, p_universe, p_time, p_uuid, p_metaClass, p_manager);
                        }
                        SmartSystemImpl.prototype.addRooms = function (p_obj) {
                            this.mutate(org.kevoree.modeling.KActionType.ADD, org.kevoree.modeling.bench.meta.MetaSmartSystem.REF_ROOMS, p_obj);
                            return this;
                        };
                        SmartSystemImpl.prototype.removeRooms = function (p_obj) {
                            this.mutate(org.kevoree.modeling.KActionType.REMOVE, org.kevoree.modeling.bench.meta.MetaSmartSystem.REF_ROOMS, p_obj);
                            return this;
                        };
                        SmartSystemImpl.prototype.getRooms = function (cb) {
                            if (cb == null) {
                                return;
                            }
                            this.ref(org.kevoree.modeling.bench.meta.MetaSmartSystem.REF_ROOMS, function (kObjects) {
                        ...
                        SmartSystemImpl.prototype.sizeOfRooms = function () {
                            return this.size(org.kevoree.modeling.bench.meta.MetaSmartSystem.REF_ROOMS);
                        };
                        return SmartSystemImpl;
                    })(org.kevoree.modeling.abs.AbstractKObject);
                    impl.SmartSystemImpl = SmartSystemImpl;
                    var SmartSystemViewImpl = (function (_super) {
                        __extends(SmartSystemViewImpl, _super);
                        function SmartSystemViewImpl(p_universe, _time, p_manager) {
                            _super.call(this, p_universe, _time, p_manager);
                        }
                        SmartSystemViewImpl.prototype.createRoom = function () {
                            return this.create(org.kevoree.modeling.bench.meta.MetaRoom.getInstance());
                        };
                        SmartSystemViewImpl.prototype.createPolynomialSensor = function () {
                            return this.create(org.kevoree.modeling.bench.meta.MetaPolynomialSensor.getInstance());
                        };
                        SmartSystemViewImpl.prototype.createSmartSystem = function () {
                            return this.create(org.kevoree.modeling.bench.meta.MetaSmartSystem.getInstance());
                        };
                        SmartSystemViewImpl.prototype.createDiscreteSensor = function () {
                            return this.create(org.kevoree.modeling.bench.meta.MetaDiscreteSensor.getInstance());
                        };
                        SmartSystemViewImpl.prototype.createSensor = function () {
                            return this.create(org.kevoree.modeling.bench.meta.MetaSensor.getInstance());
                        };
                        return SmartSystemViewImpl;
                    })(org.kevoree.modeling.abs.AbstractKView);
                    impl.SmartSystemViewImpl = SmartSystemViewImpl;
                })(impl = bench.impl || (bench.impl = {}));
                var meta;
                (function (meta) {
                    var MetaDiscreteSensor = (function (_super) {
                        __extends(MetaDiscreteSensor, _super);
                        function MetaDiscreteSensor() {
                            _super.call(this, "org.kevoree.modeling.bench.DiscreteSensor", 3);
                            var temp_all = new Array();
                            temp_all[0] = MetaDiscreteSensor.ATT_NAME;
                            temp_all[1] = MetaDiscreteSensor.ATT_VALUE;
                            var temp_references = new Array();
                            var temp_operations = new Array();
                            this.init(temp_all);
                        }
                        MetaDiscreteSensor.getInstance = function () {
                            if (MetaDiscreteSensor.INSTANCE == null) {
                                MetaDiscreteSensor.INSTANCE = new org.kevoree.modeling.bench.meta.MetaDiscreteSensor();
                            }
                            return MetaDiscreteSensor.INSTANCE;
                        };
                        MetaDiscreteSensor.INSTANCE = null;
                        MetaDiscreteSensor.ATT_NAME = new org.kevoree.modeling.meta.impl.MetaAttribute("name", 0, 0, false, org.kevoree.modeling.meta.KPrimitiveTypes.STRING, org.kevoree.modeling.extrapolation.impl.DiscreteExtrapolation.instance());
                        MetaDiscreteSensor.ATT_VALUE = new org.kevoree.modeling.meta.impl.MetaAttribute("value", 1, 0, false, org.kevoree.modeling.meta.KPrimitiveTypes.DOUBLE, org.kevoree.modeling.extrapolation.impl.DiscreteExtrapolation.instance());
                        return MetaDiscreteSensor;
                    })(org.kevoree.modeling.meta.impl.MetaClass);
                    meta.MetaDiscreteSensor = MetaDiscreteSensor;
                    var MetaPolynomialSensor = (function (_super) {
                        __extends(MetaPolynomialSensor, _super);
                        function MetaPolynomialSensor() {
                            _super.call(this, "org.kevoree.modeling.bench.PolynomialSensor", 4);
                            var temp_all = new Array();
                            temp_all[0] = MetaPolynomialSensor.ATT_NAME;
                            temp_all[1] = MetaPolynomialSensor.ATT_VALUE;
                            var temp_references = new Array();
                            temp_all[2] = MetaPolynomialSensor.REF_OP_SENSORS;
                            var temp_operations = new Array();
                            this.init(temp_all);
                        }
                        MetaPolynomialSensor.getInstance = function () {
                            if (MetaPolynomialSensor.INSTANCE == null) {
                                MetaPolynomialSensor.INSTANCE = new org.kevoree.modeling.bench.meta.MetaPolynomialSensor();
                            }
                            return MetaPolynomialSensor.INSTANCE;
                        };
                        ...
                        MetaPolynomialSensor.ATT_VALUE = new org.kevoree.modeling.meta.impl.MetaAttribute("value", 1, 0.01, false, org.kevoree.modeling.meta.KPrimitiveTypes.DOUBLE, org.kevoree.modeling.extrapolation.impl.PolynomialExtrapolation.instance());
                        MetaPolynomialSensor.REF_OP_SENSORS = new org.kevoree.modeling.meta.impl.MetaReference("op_sensors", 2, false, false, function () {
                            ...
                            return org.kevoree.modeling.bench.meta.MetaPolynomialSensor.getInstance();
                        });
                        return MetaPolynomialSensor;
                    })(org.kevoree.modeling.meta.impl.MetaClass);
                    meta.MetaPolynomialSensor = MetaPolynomialSensor;
                    var MetaRoom = (function (_super) {
                        __extends(MetaRoom, _super);
                        function MetaRoom() {
                            _super.call(this, "org.kevoree.modeling.bench.Room", 1);
                            var temp_all = new Array();
                            temp_all[0] = MetaRoom.ATT_NAME;
                            var temp_references = new Array();
                            temp_all[1] = MetaRoom.REF_SENSORS;
                            temp_all[2] = MetaRoom.REF_OP_ROOMS;
                            var temp_operations = new Array();
                            this.init(temp_all);
                        }
                        MetaRoom.getInstance = function () {
                            if (MetaRoom.INSTANCE == null) {
                                MetaRoom.INSTANCE = new org.kevoree.modeling.bench.meta.MetaRoom();
                            }
                            return MetaRoom.INSTANCE;
                        };
                        MetaRoom.INSTANCE = null;
                        MetaRoom.ATT_NAME = new org.kevoree.modeling.meta.impl.MetaAttribute("name", 0, 0, false, org.kevoree.modeling.meta.KPrimitiveTypes.STRING, org.kevoree.modeling.extrapolation.impl.DiscreteExtrapolation.instance());
                        MetaRoom.REF_SENSORS = new org.kevoree.modeling.meta.impl.MetaReference("sensors", 1, true, true, function () {
                            return org.kevoree.modeling.bench.meta.MetaPolynomialSensor.getInstance();
                        }, "op_sensors", function () {
                            return org.kevoree.modeling.bench.meta.MetaRoom.getInstance();
                        });
                        MetaRoom.REF_OP_ROOMS = new org.kevoree.modeling.meta.impl.MetaReference("op_rooms", 2, false, false, function () {
                            return org.kevoree.modeling.bench.meta.MetaSmartSystem.getInstance();
                        }, "rooms", function () {
                            return org.kevoree.modeling.bench.meta.MetaRoom.getInstance();
                        });
                        return MetaRoom;
                    })(org.kevoree.modeling.meta.impl.MetaClass);
                    meta.MetaRoom = MetaRoom;
                    var MetaSensor = (function (_super) {
                        __extends(MetaSensor, _super);
                        function MetaSensor() {
                            _super.call(this, "org.kevoree.modeling.bench.Sensor", 2);
                            var temp_all = new Array();
                        ...
                        MetaSensor.getInstance = function () {
                            if (MetaSensor.INSTANCE == null) {
                                MetaSensor.INSTANCE = new org.kevoree.modeling.bench.meta.MetaSensor();
                            }
                    ...
                    var MetaSmartSystem = (function (_super) {
                        __extends(MetaSmartSystem, _super);
                        function MetaSmartSystem() {
                            _super.call(this, "org.kevoree.modeling.bench.SmartSystem", 0);
                            var temp_all = new Array();
                            var temp_references = new Array();
                            temp_all[0] = MetaSmartSystem.REF_ROOMS;
                            var temp_operations = new Array();
                            this.init(temp_all);
                        }
                        MetaSmartSystem.getInstance = function () {
                            if (MetaSmartSystem.INSTANCE == null) {
                                MetaSmartSystem.INSTANCE = new org.kevoree.modeling.bench.meta.MetaSmartSystem();
                            }
                            return MetaSmartSystem.INSTANCE;
                        };
                        MetaSmartSystem.INSTANCE = null;
                        MetaSmartSystem.REF_ROOMS = new org.kevoree.modeling.meta.impl.MetaReference("rooms", 0, true, false, function () {
                            return org.kevoree.modeling.bench.meta.MetaRoom.getInstance();
                        }, "op_rooms", function () {
                            return org.kevoree.modeling.bench.meta.MetaSmartSystem.getInstance();
                        });
                        return MetaSmartSystem;
                    })(org.kevoree.modeling.meta.impl.MetaClass);
                    meta.MetaSmartSystem = MetaSmartSystem;
                })(meta = bench.meta || (bench.meta = {}));
            })(bench = modeling.bench || (modeling.bench = {}));
        })(modeling = kevoree.modeling || (kevoree.modeling = {}));
    })(kevoree = org.kevoree || (org.kevoree = {}));
})(org || (org = {}));
